  ...
  public: {
    Tables: {
      ...
      boleto_installments: {
        ...
        Relationships: [
          {
            foreignKeyName: "boleto_installments_boleto_id_fkey"
            columns: ["boleto_id"]
            isOneToOne: false
      ...
      card_machine_rates: {
        ...
        Relationships: [
          {
            foreignKeyName: "card_machine_rates_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "card_machine_rates_machine_id_fkey"
            columns: ["machine_id"]
            isOneToOne: false
      ...
      card_machines: {
        ...
        Relationships: [
          {
            foreignKeyName: "card_machines_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "card_machines_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      commission_people: {
        ...
        Relationships: [
          {
            foreignKeyName: "commission_people_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      sale_commissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "sale_commissions_commission_person_id_fkey"
            columns: ["commission_person_id"]
            isOneToOne: false
            referencedRelation: "commission_people"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "sale_commissions_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      sale_payments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sale_payments_machine_id_fkey"
            columns: ["machine_id"]
            isOneToOne: false
            referencedRelation: "card_machines"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      master_change_global_expiration: {
        Args: { months_input: number; reason_input: string }
        Returns: undefined
      }
