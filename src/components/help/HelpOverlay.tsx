    ...
    <>
      ...
      {createPortal(
        <button
          ...
          title="Ajuda"
          className="fixed bottom-24 sm:bottom-auto sm:top-[130px] right-4 z-40 w-8 h-8 rounded-full bg-background/80 backdrop-blur-sm border border-border shadow-sm flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent transition-colors"
        >
