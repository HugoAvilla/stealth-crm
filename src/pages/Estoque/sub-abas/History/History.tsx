...
import { HistoryAnalyticsSection } from "@/pages/Estoque/components/HistoryAnalyticsSection";
  ...
  const { data: allMaterials, isLoading: materialsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        .from("materials")
        .select(
          "*, product_types(category, light_transmission, ppf_material_type, cost_per_meter)"
        )
