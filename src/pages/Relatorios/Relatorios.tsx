...
import { ReportConfigModal } from "@/pages/Relatorios/components/ReportConfigModal";
...
export default function Relatorios() {
  ...
  return (
    <div className="space-y-6 p-[10px] border border-border rounded-lg bg-muted overflow-x-hidden">
      <HelpOverlay
        tabId="relatorios"
