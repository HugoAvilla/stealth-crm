...
import { ChevronLeft, ChevronRight, Plus, BarChart3, List, Calendar, Download, Search, Trash2, RefreshCw, Loader2, Car, User, DollarSign } from "lucide-react";
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-4">
              <div className="flex flex-wrap items-center gap-2 sm:gap-4">
                ...
                <div className="relative flex-1 min-w-[200px] w-full sm:w-auto search-container z-50">
                  ...
                  {showSearchResults && activeTab === "vendas" && searchTerm.trim().length >= 2 && (
