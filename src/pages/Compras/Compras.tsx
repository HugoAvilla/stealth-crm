...
import { PurchaseKPIs } from "@/pages/Compras/components/PurchaseKPIs";
import { PurchasesTable, PurchaseRow, PurchaseFilters } from "@/pages/Compras/components/PurchasesTable";
import { NewPurchaseModal } from "@/pages/Compras/components/NewPurchaseModal";
import { PurchaseDetailDrawer } from "@/pages/Compras/components/PurchaseDetailDrawer";
import { MonthBillsModal } from "@/pages/Compras/components/MonthBillsModal";
import { fetchPurchaseMetrics } from "@/pages/Compras/services/purchaseService";
...
export default function Compras() {
  ...
  const handleDelete = async (id: number) => {
    if (window.confirm("Tem certeza que deseja excluir esta compra? Isso reverterá pagamentos.")) {
      const { deletePurchase } = await import("@/pages/Compras/services/purchaseService");
